...
export const ColumnOptions = React.memo(
  React.forwardRef<View, ColumnOptionsProps>((props, ref) => {
    ...
    const { column, columnIndex, mobileNotification, hasCrossedColumnsLimit } =
      useColumn(columnId)
    ...
    return (
      ...
      >
        ...
        <Checkbox
          analyticsLabel="column_option_web_notification_setting"
        ...
        <Checkbox
          analyticsLabel="column_option_mobile_notification_setting"
          ...
          enableIndeterminateState={false}
          label={`Enable mobile notification`}
          onChange={(value) => {
            dispatch(
              actions.setColumnNotificationSetting({
                columnId,
                enableMobileNotification: !!value,
              }),
            )
          }}
        />
